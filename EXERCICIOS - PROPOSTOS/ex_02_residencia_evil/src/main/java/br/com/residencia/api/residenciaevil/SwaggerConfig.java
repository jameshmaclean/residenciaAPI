package br.com.residencia.api.residenciaevil;
...
public class SwaggerConfig {
	@Value("${residencia-evil.swagger.dev-url}")
	...
	public OpenAPI myOpenAPI() {
		...
		Info info = new Info()
				.title("Documentação API - Residencia Evil")
				.version("1.0.0")
				.contact(contact)
				.license(license)
				.termsOfService("https://www.residenciaevil.com/terms");
